...
def plot_roc_prc(y_true, lr_prob, xgb_prob):
...
def plot_calibration(y_true, lr_prob, xgb_prob):
...
def run_evaluation_suite():
    ...
    # Load Models
    lr_model = joblib.load(MODELS_DIR / "logistic_baseline.joblib")
    ...
    assert (y_test_lr.values == y_test_xgb.values).all(), "Test sets for LR and XGB do not align!"
    y_test = y_test_lr.values
